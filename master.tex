...
\setlist[enumerate]{label={\arabic*.},leftmargin=2em,align=left,topsep=0em,itemsep=-0.5em,labelsep=-1em,before=\vspace{2pt},after=\vspace{2pt}}
\setlist[itemize]{leftmargin=2em,align=left,topsep=0em,itemsep=-0.5em,labelsep=-1em,before=\vspace{2pt},after=\vspace{2pt}}
