...
\begin{figure}[ht]
  ...
  \label{fig:CornerNet-prediction}
\end{figure}
...
\begin{itemize}
  ...
  \item 中心度 label：利用式 $\sqrt{\frac{\mathrm{min}(l^*,
        r^*)}{\mathrm{max}(l^*, r^*)} \times \frac{\mathrm{min}(t^*,
        b^*)}{\mathrm{max}(t^*, b^*)}}$ 计算，当点位于中心时取极值 1，边缘时取极
        值 0。
\end{itemize}
